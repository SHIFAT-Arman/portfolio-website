          ...
          {links.map((link) => (
            <li key={link.text}>
              ...
              >
                <Link
                  className={`${
                    link.href === pathname ? "text-fuchsia-800 font-bold" : ""
                  }text-fuchsia-800 leading-6 font-semibold text-sm p-2 rounded-md gap-x-3 flex decoration-inherit hover:text-fuchsia-800`}
                  href={link.href}
                >
