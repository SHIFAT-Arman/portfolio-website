            ...
            <div className="max-w-2xl ml-auto mr-auto lg:grid lg:gap-x-8 lg:grid-rows-1 lg:grid-cols-1 lg:gap-y-6 lg:max-w-none lg:ml-0 lg:mr-0 ">
              ...
              <div className="max-w-xl mt-6 lg:row-start-1 lg:col-end-1 lg:mt-0 ">
                <p className="text-gray-600 leading-8 text-lg m-0">
                  ...
                  Engineering. I am also a self-taught web developer and a tech
                  enthusiast. I intend to shape my career in the field of Data
                  Science. I have been working with machine learning algorithms,
                  deep learning and Artificial Intelligence for a while now. I
                  am also trying out the CTF competition which is a competitive
                  platform for cybersecurity enthuaists.
                </p>
